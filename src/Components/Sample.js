              ...
              <div className="col-lg-6">
                <div className="leader-content">
                  ...
                  <p className="leader-quote">
                    ...
                    association with TTD for the blessings of Lord Venkateswara
                    Swamy. May His grace bring happiness, good health and
                    prosperity to every family in our region.
                  </p>
          ...
          <div className="row g-0 align-items-center">
            <div className="col-lg-5 col-md-6">
              <div className="spiritual-content">
                ...
                <p className="spiritual-desc">
                  Under the leadership of <strong>Yarapathineni Srinivasa Rao Garu</strong> the joyous
                  Christmas celebration was organized to spread the message of
                  peace, love, hope, and unity among the people. The event
                  brought together families, youth, and community members to
                  celebrate the birth of Lord Jesus Christ through prayers,
                  worship and festive gatherings.
                </p>

                <p className="spiritual-desc">
                  Thousands of devotees and Christian families gathered to
                  receive God's blessings and participate in the grand Christmas
                  celebrations, fostering harmony, compassion, and goodwill
            ...
            <div className="col-lg-7 event-highlights">
              ...
              <div className="event-highlights-grid">
                <div className="event-highlight-card">
                  ...
                  <h6>Christmas Celebrations</h6>
                  <p>
                    The divine Birth day of Jesus Christ.
                  </p>
                </div>
          ...
          <div className="row g-0 align-items-center">
            <div className="col-lg-5 col-md-6">
              <div className="spiritual-content">
                ...
                <h2 className="spiritual-title">
                  Blessed
                  <span>Eid Mubarak Celebrations</span>
                </h2>
                <p className="spiritual-desc">
                  Under the leadership <strong>Yarapathineni Srinivasa Rao Garu</strong>, the grand Eid celebrations were organized to promote the values of peace, unity, compassion, and brotherhood among the people.
                </p>
